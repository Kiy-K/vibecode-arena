...
<div
  class="fixed inset-0 bg-black/90 flex items-center justify-center z-50 animate-fade-in p-4"
>
  <div class="text-center">
    <div class="text-6xl md:text-8xl mb-4 md:mb-6 animate-bounce">🎉</div>
    <h2 class="text-2xl md:text-4xl font-bold text-green-400 mb-2">
      Challenge Complete!
    </h2>
    ...
    <div class="text-neutral-600 text-sm border-t border-neutral-800 pt-6">
      {#if submittedCount < totalPlayers}
        waiting for {totalPlayers - submittedCount} more player{totalPlayers -
          submittedCount ===
        1
          ? ""
          : "s"}...
