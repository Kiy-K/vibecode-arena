...
<div class="chat-panel flex-1 flex flex-col">
		...
		{:else}
			<div class="space-y-4 max-w-3xl mx-auto">
				{#each messages as message (message.id)}
					<div
						class="chat-message flex {message.role === 'user' ? 'justify-end' : 'justify-start'}"
					>
						<div
						...
						>
							...
							{#if message.toolCalls && message.toolCalls.length > 0}
								<div class="mb-3 space-y-2">
									{#each message.toolCalls as toolCall (toolCall.toolName)}
										<div
											class="flex items-center gap-2 text-xs bg-orange-500/10 border border-orange-500/20 px-3 py-2"
										>
											<svg
	...
	<!-- Chat Input -->
	<div class="p-3 md:p-6 bg-gradient-to-t from-neutral-950 via-neutral-950/80 to-transparent">
			...
			<div class="relative group">
				...
				>
					<textarea
						...
						placeholder={submitted ? 'solution submitted' : 'tell your ai what to do...'}
						disabled={submitted}
						rows="3"
