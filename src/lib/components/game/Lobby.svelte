  ...
  <div class="w-full max-w-4xl border border-neutral-800 flex flex-col md:flex-row min-h-[500px]">
    ...
    <div class="flex-1 flex flex-col items-center justify-center p-8">
      ...
      >
        ...
        <div class="text-5xl md:text-6xl font-mono font-bold tracking-[0.4em] text-white group-hover:text-orange-500 transition-colors">
          {room.code}
        </div>
    ...
    {#if isHost}
      ...
      <div class="text-xs mt-3 h-4 {sandboxReady && !starting ? 'text-neutral-600' : 'text-transparent'}">press Enter</div>
    {:else}
