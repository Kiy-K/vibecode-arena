	...
	<div class="w-full max-w-4xl border border-neutral-800 flex flex-col md:flex-row min-h-[500px]" style="view-transition-name: main-card;">
		...
		<div class="flex-1 flex flex-col items-center justify-center p-8" style="view-transition-name: main-content;">
			...
			<div class="w-full max-w-sm">
				<h1 class="text-2xl font-bold mb-8 text-center">join room</h1>
				...
				>
					...
					<!-- Room code -->
					<div>
						<label for="code" class="block text-neutral-600 text-xs mb-2 uppercase tracking-widest">
							room code
						</label>
						<input
							type="text"
							...
							bind:value={roomCode}
							placeholder="XXXXXX"
							class="w-full px-4 py-3 bg-black border border-neutral-800 text-white placeholder-neutral-600 focus:outline-none focus:border-orange-500/50 transition-colors uppercase tracking-[0.5em] text-center text-xl font-mono"
						/>
					</div>
		...
		<div class="hidden md:flex w-72 bg-neutral-950/50 border-l border-neutral-800 flex-col" style="view-transition-name: side-panel;">
			...
			<div class="flex-1 p-4 font-mono text-xs space-y-4">
				<div class="text-neutral-400">
					<span class="text-orange-500">1.</span> enter the room code
				</div>
				<div class="text-neutral-400">
					<span class="text-orange-500">2.</span> pick your AI model
				</div>
				<div class="text-neutral-400">
					<span class="text-orange-500">3.</span> wait for the host to start
				</div>
				<div class="text-neutral-400">
					<span class="text-orange-500">4.</span> prompt your AI to build UIs
				</div>
				...
				<div class="mt-4 text-neutral-500 text-xs">
					choose wisely based on your prompting skills! <div class="mt-2">
						(some models may be disabled in production for cost reasons)
					</div>
				</div>
			</div>
		</div>
